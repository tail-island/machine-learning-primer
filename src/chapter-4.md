...
このアテンションの採用に加えて、深層学習ってのは本来固定長の入力しか受け付けられないのだけど、それをプログラム上の工夫で可変長にして、さらに、最初の単語までの情報から次の単語を何にすべきか学習するのと並行して2番目の単語までの情報から3番目の単語を何にすべきか学習して学習速度を向上させたのが、Transformerという深層学習のモデルです。Transformerは、翻訳タスクで圧倒的な精度を叩き出して皆を驚かせました。
